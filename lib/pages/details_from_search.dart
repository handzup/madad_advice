                      ...
                      ? Column(
                          ...
                          children: <Widget>[
                            ...
                            SingleChildScrollView(
                                ...
                                child: _buildDownloadFiles(
                                    article.article.prikreplennye_fayly))
                          ],
                        )
                      : SizedBox.shrink(),
                  SizedBox(
                    ...
                    children: <Widget>[
                      ...
                      Wrap(
                        ...
                        children: List.generate(
                            getSopes(article.article.scopes).length, (index) {
                          return Tag(
                            tagRoute:
                                getSopes(article.article.scopes)[index].url,
                            tagName:
                                getSopes(article.article.scopes)[index].name,
                          );
                        }),
                      ),
                    ],
